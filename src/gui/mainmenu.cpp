...
namespace sbe
{
        ...
        : Menu(psFile, imgHandler, cfgReader, r, psPos, next)
    {
        ...
        createButton("select", callObject, selectFunction, sf::String("Test level", font, 24), sf::Color(225, 225, 225, 255), sf::Vector2f(125, 175), sf::Vector2f(280, 215), sf::Color(30, 30, 50, 0), true, 1, sf::Color::White);
