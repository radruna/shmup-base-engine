...
namespace sbe
{
        ...
        : Menu(psFile, imgHandler, cReader, r, psPos, next)
    {
        ...
        createString("options", "SBE - Options", font, 30, sf::Vector2f(0, 0));
        ...
        createString("curRes", curRes, font, 22, sf::Vector2f(312, 168));
        ...
        createButton("apply", callObject, applyFunction, sf::String("Apply", font, 20), sf::Color(225, 225, 225, 255), sf::Vector2f(125, res.y - 220), sf::Vector2f(280, res.y - 180), sf::Color(30, 80, 30, 80), true, 1, sf::Color::White);
