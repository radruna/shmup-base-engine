...
namespace sbe
{
    Button::Button(void* callObject, void (*callFunction) (void* object, const sf::Unicode::Text& text), const sf::String& text, const sf::Color& txtCol, const sf::Vector2f& p1, const sf::Vector2f& p2, const sf::Color& color, const float& outline, const sf::Color& outlineColor)
        : string(text)
    {
